...
def translate_to_tamil(french_sentence):
    # Your pre-trained model translation logic here
...
def handle_translate():
    ...
    if selected_language == "English to French":
        translation = translate_to_french(sentence)
    elif selected_language == "English to Spanish":
        translation = translate_to_spanish(sentence)
    elif selected_language == "French to Tamil":
        translation = translate_to_tamil(sentence)
...
language_label.pack()
language_select = ttk.Combobox(root, textvariable=language_var, values=["English to French", "English to Spanish", "French to Tamil"], font=(font_style, font_size), state="readonly")
